...
//draw compares background to foreground 
function draw() {
...
/****** UPDATING BACKGROUND MODEL   ******/
         //can comment this section out to make script faster
...
/******   END UPDATING BACKGROUND MODEL   ******/
   ...
   //call this function for every frame
   setTimeout(draw);
}
